      ...
      style={styles.container}>
       <Header 
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          ...
          <TouchableOpacity style={styles.formButton} onPress={() => this.submitCred()}>
...
function mapDispatchToProps(dispatch){
  return{
    submitCredUser: (username) => dispatch({type: 'SUBMIT_CRED_USER', payload: username}),
    submitCredPass: (password) => dispatch({type: 'SUBMIT_CRED_PASS', payload: password}),
  }
}
